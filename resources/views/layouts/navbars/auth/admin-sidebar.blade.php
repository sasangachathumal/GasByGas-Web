    ...
    <div class="collapse navbar-collapse w-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link me-auto {{ (Request::is('admin/gas-request-management') ? 'active' : '') }}" href="{{ url('admin/gas-request-management') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link me-auto {{ (Request::is('admin/schedule-management') ? 'active' : '') }}" href="{{ url('admin/schedule-management') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link me-auto {{ (Request::is('admin/outlet-management') ? 'active' : '') }}" href="{{ url('admin/outlet-management') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link me-auto {{ (Request::is('admin/gas-management') ? 'active' : '') }}" href="{{ url('admin/gas-management') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
